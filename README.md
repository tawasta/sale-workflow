...
[sale_order_committed_date_automation](sale_order_committed_date_automation/) | 17.0.1.0.0 |  | Automatically compute sale order commitment date on confirmation
...
[sale_order_customer_marking](sale_order_customer_marking/) | 17.0.1.0.0 |  | Adds a freetext field to SO, to supplement the existing Customer Reference field
[sale_order_customer_marking_report](sale_order_customer_marking_report/) | 17.0.1.0.1 |  | Sale Customer Marking Report
[sale_order_customer_order_date](sale_order_customer_order_date/) | 17.0.1.0.1 |  | Customer order date field to sale order
[sale_order_default_payment_term](sale_order_default_payment_term/) | 17.0.1.0.0 |  | Set a default payment term for sales if a partner does not have one
...
[sale_order_membership_attachment](sale_order_membership_attachment/) | 17.0.1.0.0 |  | Enables sending product attachments with order confirmation email wizard
...
[sale_order_week_of_shipment](sale_order_week_of_shipment/) | 17.0.1.1.3 |  | Week of shipment field to sale order
