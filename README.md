...
--- | --- | --- | ---
[sale_blanket_order_forecast](sale_blanket_order_forecast/) | 14.0.1.1.18 |  | Allows making forecast sale orders from blanket orders
...
[sale_order_product_default_route](sale_order_product_default_route/) | 14.0.1.0.1 |  | Use default route set on a product to add it to Sale Order line
