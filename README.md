...
[sale_order_create_invoices_without_grouping](sale_order_create_invoices_without_grouping/) | 14.0.1.0.0 |  | Select not to consolidate created invoices from several sale orders
