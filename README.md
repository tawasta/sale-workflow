...
--- | --- | --- | ---
[sale_blanket_order_forecast](sale_blanket_order_forecast/) | 14.0.1.1.19 |  | Allows making forecast sale orders from blanket orders
...
[sale_multi_company](sale_multi_company/) | 14.0.1.2.2 |  | Allows selling multiple company products on a single sale
...
[sale_order_partner_disable_onchange_for_delivery_address](sale_order_partner_disable_onchange_for_delivery_address/) | 14.0.1.0.1 |  | Disable partner (customer) onchange on sale for Delivery address
...
[sale_order_product_default_route](sale_order_product_default_route/) | 14.0.1.0.2 |  | Use default route set on a product to add it to Sale Order line
...
[sale_order_search_multi_value](sale_order_search_multi_value/) | 14.0.1.0.0 |  | Search sale orders with a list of sale order names
