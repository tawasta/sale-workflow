...
class SaleOrder(models.Model):
    ...
    def copy_membership_attachments_from_product(self):
        """Copy any membership product attachments from product to sale
        order, so they're ready to be added to mail wizard by OCA's
        ...
        for sale_order in self:
            ...
            for line in sale_order.order_line:
                ...
                for attachment in line.product_id.membership_attachment_ids:
                    ...
                    if attachment.checksum in existing_checksums:
                        continue
                    attachment.copy(
                        {"res_model": "sale.order", "res_id": sale_order.id}
                    )
