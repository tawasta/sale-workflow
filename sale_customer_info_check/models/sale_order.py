...
class SaleOrder(models.Model):      
    ...
    partner_info_msg = fields.Char(compute='_get_customer_info_msg', size=256, string="Customer info status")
    ...
    #         return _("Outdated - verified more than ") + str(self._DAY_THRESHOLD) + " " + _('days ago')
    #     else:
    #         return _('Verified on ') + updated.strftime("%Y-%m-%d")
    ...
    #             missing_info.append(_('Business ID'))
    
    #         if partner.vat is False and vat_required is True:
    #             missing_info.append(_('VAT'))
    
    #     if len(missing_info) > 0:
    #         return _('Missing information: ') + ",".join(missing_info)
    #     else:
    #         return _('OK')
    ...
    #     else: 
    #         result['value']['partner_info_msg'] = self._read_customer_uptodate_info(partner_id)
